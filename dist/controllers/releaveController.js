...
var get_user = function get_user(req, res) {
...
var get_restroom = function get_restroom(req, res) {
...
var create_restroom = function create_restroom(req, res) {
...
var update_restroom = function update_restroom(req, res) {
...
var delete_restroom = function delete_restroom(req, res) {
	// Delete restroom
...
var get_area_restrooms = function get_area_restrooms(req, res) {
...
var handle_auth_error = function handle_auth_error(err, req, res, next) {
...
var create_token = function create_token(auth) {
	return jwt.sign({
		id: auth.id
...
var generate_token = function generate_token(req, res, next) {
	req.token = create_token(req.auth);
	next();
};

var send_token = function send_token(req, res) {
...
var upsert_fb_user = function upsert_fb_user(req, res, next) {
...
var get_current_user = function get_current_user(req, res, next) {
...
//# sourceMappingURL=releaveController.js.map